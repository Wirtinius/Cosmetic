  ...
  return (
    <nav className='relative border-y-2 mx-0'>
      <div className='flex text-center justify-evenly space-x-6'>
        ...
        {/* Links */}
        <div className='hidden md:flex space-x-8 my-6'>
          ...
          <Link className='group' to="/">
            <span className='opacity-50 group-hover:opacity-100 link-underline link-underline-black text-black'>Semi-Annual Beauty Event</span>
          </Link>
